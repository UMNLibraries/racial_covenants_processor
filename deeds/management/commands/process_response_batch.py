...
from deeds.models import ZooniverseResponseFlat, ZooniverseUser
...
class Command(BaseCommand):
    ...
    def calculate_user_rank(self, workflow_name):
        #-------------------------------------------------------------------
        #----------------------PART II: User_Rank---------------------------
        #-------------------------------------------------------------------
        ...
        reliability_df = reliability_df.reset_index(drop=False).merge(
            users_qs,
            how="left",
            left_on="index",
            right_on="db_id"
